      ...
      <main className="flex-grow">
        ...
        <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0 z-0">
             ...
             {/* Заглушка для фона, можно добавить скриншот игры позже */}
        ...
        <section id="media" className="py-24 bg-slate-900/30">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="aspect-video bg-slate-800 rounded-xl flex items-center justify-center animate-pulse">
